...
import com.adrdf.test.camera.CameraManager;
import com.adrdf.test.camera.Config;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CameraManager.get().setPictureCallback(new PictureCallback() {
			...
			public void onPictureTaken(byte[] data, Camera camera) {
				...
				Bitmap cameraBitmap = RdfImageUtil.getBitmap(data,1280,720);
                ...
                //插入到相册数据库
                try{
                    String  url = insertImage(CaptureActivity.this.getContentResolver(), cameraBitmap, "adrdf", "adrdf");
                    path = getRealFilePath(CaptureActivity.this,Uri.parse(url));
                    Log.e("onPictureTaken", "onPictureTaken insertImage："+path);
                    RdfToastUtil.showToast(CaptureActivity.this,"insertImage:"+path);
                }catch (Exception e){
                    e.printStackTrace();
                }
