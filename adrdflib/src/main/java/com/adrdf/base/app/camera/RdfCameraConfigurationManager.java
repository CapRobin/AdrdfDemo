 ...
 * Copyright © CapRobin
 *
 * Name：RdfCameraConfigurationManager
 * Describe：
 * Date：2017-05-27 09:55:41
 * Author: CapRobin@yeah.net
 *
 */
final class RdfCameraConfigurationManager {

	private static final String TAG = RdfCameraConfigurationManager.class.getSimpleName();
	...
	RdfCameraConfigurationManager(Context context) {
