package com.adrdf.base.app.camera;
 ...
 * Copyright © CapRobin
 *
 * Name：RdfCameraManager
 * Describe：
 * Date：2017-05-27 08:56:20
 * Author: CapRobin@yeah.net
 *
 */
public final class RdfCameraManager {

	private static final String TAG = RdfCameraManager.class.getSimpleName();

	private static RdfCameraManager cameraManager;
	private final RdfCameraConfigurationManager configManager;
	...
	public static void init(Context context) {
		if (cameraManager == null) {
			cameraManager = new RdfCameraManager(context);
		}
	}

	public static RdfCameraManager get() {
		return cameraManager;
	}

	private RdfCameraManager(Context context) {
		this.configManager = new RdfCameraConfigurationManager(context);
	}
	...
	public RdfCameraConfigurationManager getConfigManager() {
