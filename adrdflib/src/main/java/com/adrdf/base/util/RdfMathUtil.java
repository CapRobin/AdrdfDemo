...
import com.adrdf.base.model.RdfCircle;
import com.adrdf.base.model.RdfPoint;
 ...
 * Name：RdfMathUtil
 * Describe：数学工具类
 * Date：2017-09-27 11:07:59
 * Author: CapRobin@yeah.net
 *
 */
public class RdfMathUtil {
   ...
   */
	 ...
	 * @return
	 */
    public static boolean pointOnCircle(RdfPoint point, RdfCircle c1, RdfCircle c2){
    ...
    /**
 	 ...
 	 * @return
 	 */
     public static boolean pointOnCircle(RdfPoint point, RdfCircle c1, RdfCircle c2, float offset){
     ...
     * @return
     */
    public static boolean pointInCircle(RdfPoint point, RdfCircle circle){
     ...
     * @return
     */
    public static double getDistance(RdfPoint p1, RdfPoint p2) {
	 ...
	 * @return
	 */
	public static List<RdfPoint> circleCrossoverPoint(RdfCircle circle1, RdfCircle circle2){
		List<RdfPoint> pointList = new ArrayList<RdfPoint>();
		//第一个圆的参数方程:
		// x = r1 * cosCita + x1
		// y = r1 * sinCita + y1
		...
		Set<RdfPoint> pointSet = new HashSet<RdfPoint>();
		RdfPoint p1_1 = new RdfPoint(x_1,y_1_1);
		if(pointOnCircle(p1_1,circle1,circle2)){
			pointSet.add(p1_1);
		}
		
		RdfPoint p1_2 = new RdfPoint(x_1,y_1_2);
		...
		RdfPoint p2_1 = new RdfPoint(x_2,y_2_1);
		if(pointOnCircle(p2_1,circle1,circle2)){
			pointSet.add(p2_1);
		}
		
		RdfPoint p2_2 = new RdfPoint(x_2,y_2_2);
		if(pointOnCircle(p2_2,circle1,circle2)){
			pointSet.add(p2_2);
		}
		for(Iterator<RdfPoint> iter = pointSet.iterator(); iter.hasNext();){
			RdfPoint point = (RdfPoint)iter.next();
			pointList.add(point);
        }  
		return pointList;
	}
