 ...
 * Name：RdfLogUtil
 * Describe：日志工具类
 * Date：2017-03-27 19:07:38
 * Author: CapRobin@yeah.net
 *
 */
public class RdfLogUtil {

    /** debug开关. */
	public static boolean D = RdfAppConfig.LOG_DEBUG;

	/** info开关. */
	public static boolean I = RdfAppConfig.LOG_INFO;

	/** error开关. */
	public static boolean E = RdfAppConfig.LOG_ERROR;
	...
	private static String buildMessage(String format, Object... args) {
        ...
        for (int i = 2; i < trace.length; i++) {
            ...
            if (!clazz.equals(RdfLogUtil.class)) {
