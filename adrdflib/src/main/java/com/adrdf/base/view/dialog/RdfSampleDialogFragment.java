 ...
 * Copyright © CapRobin
 *
 * Name：RdfSampleDialogFragment
 * Describe：弹出框
 * Date：2017-03-17 11:14:38
 * Author: CapRobin@yeah.net
 *
 */
public class RdfSampleDialogFragment extends DialogFragment {
	 ...
	 */
	public static RdfSampleDialogFragment newInstance(int style, int theme, int gravity) {
		RdfSampleDialogFragment f = new RdfSampleDialogFragment();
