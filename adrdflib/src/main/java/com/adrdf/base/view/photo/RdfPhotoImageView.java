 ...
 * Copyright © CapRobin
 *
 * Name：RdfPhotoImageView
 * Describe：手势图片控件
 * Date：2017-08-22 11:20:09
 * Author: CapRobin@yeah.net
 *
 */
public class RdfPhotoImageView extends ImageView {
        ...
        public interface OuterMatrixChangedListener {
             ...
             */
            void onOuterMatrixChanged(RdfPhotoImageView pinchImageView);
        }
        ...
        public RdfPhotoImageView(Context context) {
            super(context);
            initView();
        }

        public RdfPhotoImageView(Context context, AttributeSet attrs) {
            super(context, attrs);
            initView();
        }

        public RdfPhotoImageView(Context context, AttributeSet attrs, int defStyle) {
         ...
         * 在onTouchEvent末尾被执行.
         */
        private GestureDetector mGestureDetector = new GestureDetector(RdfPhotoImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (mOnLongClickListener != null) {
                    mOnLongClickListener.onLongClick(RdfPhotoImageView.this);
                }
            }
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (mOnClickListener != null) {
                    mOnClickListener.onClick(RdfPhotoImageView.this);
                }
                return true;
            }
        });
