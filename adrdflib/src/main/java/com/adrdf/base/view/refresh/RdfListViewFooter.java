 ...
 * Copyright © CapRobin
 *
 * Name：RdfListViewFooter
 * Describe：加载更多Footer View类
 * Date：2017-06-27 11:22:04
 * Author: CapRobin@yeah.net
 *
 */
public class RdfListViewFooter extends LinearLayout {
	 ...
	 */
	public RdfListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public RdfListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(RdfViewUtil.scaleValue(mContext,100));
		footerTextView = new TextView(context);  
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		RdfViewUtil.setTextSize(footerTextView,30);

		RdfViewUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.width = RdfViewUtil.scaleValue(mContext, 50);
		layoutParamsWW.height = RdfViewUtil.scaleValue(mContext, 50);
		layoutParamsWW.rightMargin = RdfViewUtil.scaleValue(mContext, 10);
