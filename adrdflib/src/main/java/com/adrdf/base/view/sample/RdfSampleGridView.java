 ...
 * Copyright © CapRobin
 *
 * Name：RdfSampleGridView
 * Describe：自定义GirdView 适合一次性展现所有的，不包含滚动与View缓存
 * Date：2017-06-27 20:25:25
 * Author: CapRobin@yeah.net
 *
 */

public class RdfSampleGridView extends LinearLayout {
	...
	public RdfSampleGridView(Context context) {
		this(context, null);
	}

	public RdfSampleGridView(Context context, AttributeSet attrs, int defStyle) {
	...
	public RdfSampleGridView(Context context, AttributeSet attrs) {
