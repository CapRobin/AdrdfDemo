...
package com.adrdf.base.view.progress;
...
import com.adrdf.base.view.listener.RdfOnProgressListener;

/**
 * Copyright © CapRobin
 *
 * Name：RdfHorizontalProgressBar
 * Describe：长条形的ProgressBar
 * Date：2017-06-27 11:21:36
 * Author: CapRobin@yeah.net
 *
 */
public class RdfHorizontalProgressBar extends View {
	...
	/** 监听器. */
	private RdfOnProgressListener onProgressListener = null;
	 ...
	 */
	public RdfHorizontalProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
	...
	public RdfOnProgressListener getAbOnProgressListener() {
		return onProgressListener;
	}

	public void setOnProgressListener(RdfOnProgressListener onProgressListener) {
