...
package com.adrdf.base.view.scene;
 ...
 * Name：RdfAnalogClock
 * Describe：自定义模拟时钟
 * Date：2017-06-27 11:27:59
 * Author: CapRobin@yeah.net
 *
 */

public class RdfAnalogClock extends View {
	 ...
	 */
	public RdfAnalogClock(Context context) {
		super(context);
		init(context);
	}
	 ...
	 * @param context the context
	 */
	public RdfAnalogClock(Context context, AttributeSet attrs) {
		super(context, attrs);

		init(context);

		TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RdfAnalogClock);
		dialDrawable = typedArray.getDrawable(R.styleable.RdfAnalogClock_dialDrawable);
		hourDrawable = typedArray.getDrawable(R.styleable.RdfAnalogClock_hourDrawable);
		minuteDrawable = typedArray.getDrawable(R.styleable.RdfAnalogClock_minuteDrawable);
		secondDrawable = typedArray.getDrawable(R.styleable.RdfAnalogClock_secondDrawable);
		typedArray.recycle();
