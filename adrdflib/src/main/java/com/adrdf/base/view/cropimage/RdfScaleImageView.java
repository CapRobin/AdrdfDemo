 ...
 * Copyright © CapRobin
 *
 * Name：RdfScaleImageView
 * Describe：可控制放大缩小的ImageView
 * Date：2016-12-12 18:13:15
 * Author: CapRobin@yeah.net
 *
 */
public abstract class RdfScaleImageView extends ImageView {
	...
	/** 当前显示的Bitmap. */
	final public RdfRotateBitmap bitmapDisplayed = new RdfRotateBitmap(null);
	...
	public RdfScaleImageView(Context context) {
		super(context);
		init();
	}


	public RdfScaleImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	private void setImageBitmap(Bitmap bitmap, int rotation) {
		...
		if (old != null && old != bitmap) {
			RdfImageUtil.releaseBitmap(old);
		}
	}
	...
	public void setImageBitmapResetBase(final Bitmap bitmap,
		...
		setImageRotateBitmapResetBase(new RdfRotateBitmap(bitmap), resetSupp);
	}

	public void setImageRotateBitmapResetBase(final RdfRotateBitmap bitmap,
			final boolean resetSupp) {
	...
	private void getProperBaseMatrix(RdfRotateBitmap bitmap, Matrix matrix) {
