 ...
 * Name：RdfCropHelper
 * Describe：图片裁剪处理
 * Date：2017-03-27 11:12:13
 * Author: CapRobin@yeah.net
 *
 */
public class RdfCropHelper {

	private Context context;
	public boolean waitingToPick;
	public boolean saving;
	public RdfHighlightView highlightView;
	private Handler handler = new Handler ();
	private RdfCropImageView imageView;
	private Bitmap bitmap;


	public RdfCropHelper(Context context, RdfCropImageView imageView){
	...
	Runnable mRunFaceDetection = new Runnable() {
		...
		private void handleFace(FaceDetector.Face f) {
			...
			RdfHighlightView hv = new RdfHighlightView(imageView);
