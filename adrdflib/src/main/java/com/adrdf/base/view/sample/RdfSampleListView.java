 ...
 * Copyright © CapRobin
 *
 * Name：RdfSampleListView
 * Describe：自定义ListView 适合一次性展现所有的，不包含滚动与View缓存
 * Date：2017-03-21 11:25:40
 * Author: CapRobin@yeah.net
 *
 */
public class RdfSampleListView extends LinearLayout {

    /** AbSampleListView self . */
    private RdfSampleListView view = null;
	...
	public RdfSampleListView(Context context) {
		this(context, null);
	}

	public RdfSampleListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
        init();

	}

	public RdfSampleListView(Context context, AttributeSet attrs) {
