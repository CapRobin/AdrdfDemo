...
import com.adrdf.base.app.adapter.RdfViewPagerAdapter;
import com.adrdf.base.view.listener.RdfOnChangeListener;
import com.adrdf.base.view.listener.RdfOnItemClickListener;
import com.adrdf.base.view.listener.RdfOnScrollListener;
import com.adrdf.base.view.listener.RdfOnTouchListener;
 ...
 * Name：RdfPlayView
 * Describe：可播放显示的View
 * Date：2017-06-27 11:25:11
 * Author: CapRobin@yeah.net
 *
 */
public class RdfPlayView extends LinearLayout {
	
	/** 上下文. */
	private Context context;

	/** 内部的ViewPager. */
	private RdfInnerViewPager mViewPager;
	...
	/** 点击. */
	private RdfOnItemClickListener mOnItemClickListener;
	
	/** 改变. */
	private RdfOnChangeListener mChangeListener;
	
	/** 滚动. */
	private RdfOnScrollListener mScrolledListener;
	
	/** 触摸. */
	private RdfOnTouchListener mOnTouchListener;
	
	/** List views. */
	private ArrayList<View> mViewList = null;
	
	/** 适配器. */
	private RdfViewPagerAdapter mViewPagerAdapter = null;
	 ...
	 */
	public RdfPlayView(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public RdfPlayView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void initView(Context context){
		...
		mViewPager = new RdfInnerViewPager(context);
		...
		mViewPagerAdapter = new RdfViewPagerAdapter(context,mViewList);
	 ...
	 */
    public void setOnPageChangeListener(RdfOnChangeListener onChangeListener) {
     ...
     */
    public void setOnPageScrolledListener(RdfOnScrollListener onScrollListener) {
     ...
     */
    public void setOnTouchListener(RdfOnTouchListener onTouchListener){
