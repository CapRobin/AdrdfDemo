package com.adrdf.base.view.expandtabview;
...
import com.adrdf.base.view.listener.RdfOnCheckedChangedListener;
 ...
 * Copyright © CapRobin
 *
 * Name：RdfExpandTabView
 * Describe：分类展开控件，封装了下拉动画
 * Date：2017-06-27 11:15:23
 * Author: CapRobin@yeah.net
 *
 */
public class RdfExpandTabView extends LinearLayout {

    private Context context;

    private PopupWindow popupWindow;

    private RdfOnCheckedChangedListener onCheckedChangedListener;
     ...
     * @param context
     */
    public RdfExpandTabView(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public RdfExpandTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        DisplayMetrics display = RdfAppUtil.getDisplayMetrics(context);
    ...
    public void setData(List<String> tabTexts,List<View> contentViews) {
        ...
        for (int i = 0; i < contentViews.size(); i++) {
            ...
            RdfViewUtil.setTextSize(tabButton, 28);

            addView(tabButton,new LayoutParams(0,LayoutParams.WRAP_CONTENT,1));

            View line = new View(context);
            line.setBackgroundResource(com.adrdf.library.R.color.gray_line);
     ...
     * 获取tab的监听事件
     */
    public RdfOnCheckedChangedListener getOnCheckedChangedListener() {
     ...
     * 设置tab的监听事件
     */
    public void setOnCheckedChangedListener(RdfOnCheckedChangedListener onCheckedChangedListener) {
    ...
    public void setTabTextSize(float size){
        for(ToggleButton tab:tabButtons){
            RdfViewUtil.setTextSize(tab, size);
        }
    }
