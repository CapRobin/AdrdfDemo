...
import com.adrdf.base.util.RdfGraphicUtil;
 ...
 * Name：RdfWheelView
 * Describe：轮子选择View
 * Date：2017-04-14 16:30:14
 * Author: CapRobin@yeah.net
 *
 */
public class RdfWheelView extends View {
	...
	// Wheel Values
	/** The adapter. */
	private RdfWheelAdapter adapter = null;
	 ...
	 */
	public RdfWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs the attrs
	 */
	public RdfWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * @param context the context
	 */
	public RdfWheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 * @return the adapter
	 */
	public RdfWheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(RdfWheelAdapter adapter) {
	...
	private int getMaxTextLength() {
		RdfWheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			//一个字符宽度
			float textWidth = (int) RdfGraphicUtil.getStringWidth("0", labelPaint);
			//不算lable的宽度
		...
		if (label != null && label.length() > 0) {
			labelWidth = (int) RdfGraphicUtil.getStringWidth(label, labelPaint);
		}
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = RdfViewUtil.scaleTextValue(mContext, textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = RdfViewUtil.scaleTextValue(mContext, labelTextSize);
	}
	...
	public interface AbOnWheelScrollListener {
		 ...
		 */
		void onScrollingStarted(RdfWheelView wheel);
		
		/**
		 * Callback method to be invoked when scrolling ended.
		 * @param wheel the wheel view whose state has changed.
		 */
		void onScrollingFinished(RdfWheelView wheel);
	}
	...
	public interface AbOnWheelChangedListener {
		 ...
		 */
		void onChanged(RdfWheelView wheel, int oldValue, int newValue);
	}
