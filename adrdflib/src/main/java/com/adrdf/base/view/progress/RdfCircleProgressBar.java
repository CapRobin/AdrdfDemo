 ...
 * Copyright © CapRobin
 *
 * Name：RdfCircleProgressBar
 * Describe：环形的ProgressBar
 * Date：2016-11-17 11:21:12
 * Author: CapRobin@yeah.net
 *
 */
public class RdfCircleProgressBar extends View {
	 ...
	 */
	public RdfCircleProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
	...
	public RdfOnProgressListener getOnProgressListener() {
